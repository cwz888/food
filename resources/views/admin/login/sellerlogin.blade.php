                ...
                <form class="form" method="" action="">
                    ...
                    <div class="content">
                        <div class="input-group form-group-no-border input-lg">
                            ...
                            <input type="text" class="form-control" id="seller_name" placeholder="请输入商户名称...">
                        </div>
                        <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                                    <i class="now-ui-icons text_caps-small"></i>
                                </span>
                            <input type="text" id="seller_pwd" placeholder="请输入密码..." class="form-control" />
                        </div>
                    </div>
                    <div class="footer text-center">
                        <a href="" class="btn btn-primary btn-round btn-lg btn-block">登录</a>
                    </div>
                    <div class="pull-left">
                        <h6>
        ...
        $.ajax({
            ...
            success:function(res){
                if(res.code==200 && res.message=='success'){
                    location.href="http://www.wifeliu.com/admin/index";
                }else{
                    alert(res.message);
                }
            }
