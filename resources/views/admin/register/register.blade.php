            ...
            <div class="card card-login card-plain">
                    ...
                    <div class="content">
                        <div class="input-group form-group-no-border input-lg">
                            ...
                            <input type="text" class="form-control" id="seller_name" placeholder="请输入要注册的商户名称...">
                        </div>
                        <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                                    <i class="now-ui-icons text_caps-small"></i>
                                </span>
                            <input type="text" id="seller_pwd" placeholder="请输入要注册的密码..." class="form-control" />
                        </div>
                    </div>
                    <div class="footer text-center">
                        <input type="button" id="btn" value="注册" class="btn btn-primary btn-round btn-lg btn-block">
...
<script>
    $(document).on('click','#btn',function(){
        ...
        $.ajax({
            url:"success",
            data:{seller_name:seller_name,seller_pwd:seller_pwd},
            type:'GET',
            dataType:'json',
            success:function(res){
                if(res.code==200 && res.message=='success'){
                    location.href="http://www.wifeliu.com/login/sellerLogin";
                }else{
                    alert(res.message);
                }
            }
