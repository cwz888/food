                ...
                <form class="form" method="" action="">
                    <div class="header header-primary text-center">
                        <div class="logo-container">
                            <img src="{{asset('assets/img/timg.jpg')}}" alt="">
                        </div>
                    </div>
                    <div class="content">
                        <div class="footer text-center">
                            <a href="http://www.wifeliu.com/login/sellerLogin" class="btn  btn-round btn-lg btn-block">管理员登录</a>
                        </div>
                        <div class="footer text-center">
                            <a href="http://www.wifeliu.com/login/userLogin" class="btn  btn-round btn-lg btn-block">用户登录</a>
                        </div>
                        <div class="footer text-center">
                            <a href="http://www.wifeliu.com/register/register" class="btn btn-primary btn-round btn-lg btn-block">注册</a>
                        </div>
                    </div>
